...
use App\Exports\DentalManagement\Patients\PatientsExport;
use Maatwebsite\Excel\Excel as ExcelFormat;

class GeneratePatientsExcelJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $content = Excel::raw(new PatientsExport($patients), ExcelFormat::XLSX);
            ...
            \Log::error('GeneratePatientsExcelJob failed', [
                'error' => $e->getMessage(),
    ...
    {
        return __('dental_management.patients.export_filename') . '_' . now()->format('Y-m-d_H-i-s') . '.xlsx';
    }
}