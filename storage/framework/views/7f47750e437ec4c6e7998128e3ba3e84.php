...
<div class="mb-3">
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addImageModal">
    <i class="fas fa-plus"></i> <?php echo e(__('dental_management.patients.upload_image')); ?>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addImageModalLabel">
          <i class="fas fa-image"></i> <?php echo e(__('dental_management.patient_images.create')); ?>
      ...
      <form id="image-form" action="<?php echo e(route('dental_management.patient_images.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="patient_id" value="<?php echo e($patient->id); ?>">
        <div class="modal-body">
          <!-- Paciente (solo lectura) -->
          <div class="form-group">
            <label><?php echo e(__('dental_management.patient_images.patient_id')); ?></label>
          ...
          <div class="row">
            <div class="col-md-6">
              <!-- Título -->
              <div class="form-group">
                <label for="title"><?php echo e(__('dental_management.patient_images.fields.title')); ?> <span class="text-danger">(*)</span></label>
                <input type="text" name="title" id="title" class="form-control" required
                       placeholder="<?php echo e(__('global.placeholders.complete_attribute', ['attribute' => __('dental_management.patient_images.title')])); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <!-- Opciones de imagen -->
              <div class="form-group">
                <label><?php echo e(__('dental_management.patient_images.image')); ?> <span class="text-danger">(*)</span></label>
                <div class="mb-2">
                  <button type="button" class="btn btn-outline-primary btn-sm" id="upload-image-btn">
                    <i class="fas fa-upload"></i> <?php echo e(__('dental_management.patients.upload_image')); ?>
          ...
          <!-- Descripción -->
          <div class="form-group">
            <label for="description"><?php echo e(__('dental_management.patient_images.fields.description')); ?></label>
            <textarea name="description" id="description" class="form-control" rows="3"
                      placeholder="<?php echo e(__('global.placeholders.complete_attribute', ['attribute' => __('dental_management.patient_images.description')])); ?>"></textarea>
          </div>
        </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editImageModalLabel">
          <i class="fas fa-edit"></i> <?php echo e(__('dental_management.patient_images.edit')); ?>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <!-- Imagen actual -->
              <div class="form-group">
                <label><?php echo e(__('dental_management.patient_images.current_image')); ?></label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label><?php echo e(__('dental_management.patient_images.new_image_optional')); ?></label>
                <div class="mb-2">
          ...
          <!-- Título -->
          <div class="form-group">
            <label for="edit_title"><?php echo e(__('dental_management.patient_images.fields.title')); ?> <span class="text-danger">(*)</span></label>
          ...
          <!-- Descripción -->
          <div class="form-group">
            <label for="edit_description"><?php echo e(__('dental_management.patient_images.fields.description')); ?></label>
...
<?php if($activeImages->count() > 0): ?>
  <div class="table-responsive">
    <table class="table table-bordered table-striped" id="patient-images-table">
      <thead>
        <tr>
          <th><?php echo e(__('dental_management.patient_images.fields.date')); ?></th>
          <th><?php echo e(__('dental_management.patient_images.fields.title')); ?></th>
          <th><?php echo e(__('dental_management.patient_images.fields.description')); ?></th>
          <th><?php echo e(__('dental_management.patient_images.image')); ?></th>
          <th><?php echo e(__('global.actions')); ?></th>
        </tr>
      </thead>
      <tbody>
        <?php $__currentLoopData = $activeImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patientImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td data-order="<?php echo e($patientImage->created_at->timestamp); ?>">
              <?php echo e($patientImage->created_at->format('d/m/Y H:i')); ?>

            </td>
            <td><?php echo e($patientImage->title); ?></td>
            <td><?php echo e($patientImage->description ? Str::limit($patientImage->description, 120) : '-'); ?></td>
            <td>
              <img src="<?php echo e($patientImage->image_url); ?>" alt="<?php echo e($patientImage->title); ?>" style="height: 80px; width: 80px; object-fit: cover; border-radius: 6px;">
            </td>
            <td>
              <div class="btn-group btn-group-sm" role="group">
                <button type="button" class="btn btn-outline-info view-image" data-image="<?php echo e($patientImage->image_url); ?>" data-title="<?php echo e($patientImage->title); ?>" data-description="<?php echo e($patientImage->description); ?>" data-date="<?php echo e($patientImage->created_at->format('d/m/Y H:i')); ?>">
                  <i class="fas fa-eye"></i>
                </button>
                <button type="button" class="btn btn-outline-warning edit-image" data-id="<?php echo e($patientImage->id); ?>" data-slug="<?php echo e($patientImage->slug); ?>" data-title="<?php echo e($patientImage->title); ?>" data-description="<?php echo e($patientImage->description); ?>" data-image="<?php echo e($patientImage->image_url); ?>">
                  <i class="fas fa-edit"></i>
                </button>
                <button type="button" class="btn btn-outline-danger delete-image" data-id="<?php echo e($patientImage->id); ?>" data-slug="<?php echo e($patientImage->slug); ?>" data-title="<?php echo e($patientImage->title); ?>">
...
<?php else: ?>
  <div class="alert alert-info">
    <i class="fas fa-info-circle"></i> <?php echo e(__('dental_management.patient_images.no_images')); ?>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteImageModalLabel">
          <i class="fas fa-trash text-danger"></i> <?php echo e(__('global.confirm_delete')); ?>
      ...
      <form id="deleteImageForm">
        ...
        <div class="modal-body">
          <div class="alert alert-warning">
            ...
            <strong><?php echo e(__('global.attention')); ?>:</strong> <?php echo e(__('global.confirm_delete_text')); ?>

          </div>

          <div class="form-group">
            <label for="delete_reason" class="font-weight-bold">
              <?php echo e(__('dental_management.patient_images.fields.delete_reason')); ?> <span class="text-danger">(*)</span>
            </label>
            <textarea
              name="reason"
              id="delete_reason"
              class="form-control"
              rows="3"
              placeholder="<?php echo e(__('global.placeholders.complete_attribute', ['attribute' => __('dental_management.patient_images.fields.delete_reason')])); ?>"
              required
              minlength="10"
              maxlength="500"></textarea>
            <small class="form-text text-muted">
              <?php echo e(__('global.min_characters', ['count' => 10])); ?> - <?php echo e(__('global.max_characters', ['count' => 500])); ?>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-danger">
            <i class="fas fa-trash"></i> <?php echo e(__('global.yes_delete')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    let stream;
    let patientId = <?php echo e($patient->id); ?>;
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        ...
                        text: '<?php echo e(__("global.created_success")); ?>',
                        icon: 'success',
                        timer: 2000,
                        showConfirmButton: false
                    }).then(() => {
                        location.href = '<?php echo e(route('dental_management.patients.show', $patient)); ?>?tab=images';
                    });
                } else {
                    Swal.fire({
                        title: '<?php echo e(__("global.error")); ?>',
        ...
        editImageForm.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        title: '<?php echo e(__("global.success")); ?>',
                        text: '<?php echo e(__("global.updated_success")); ?>',
                        icon: 'success',
                        timer: 2000,
                        showConfirmButton: false
                    }).then(() => {
    ...
    function handleDeleteImage(imageSlug, imageTitle, imageDescription) {
        ...
        if (deleteForm) {
            deleteForm.action = `<?php echo e(url('dental_management/patient_images')); ?>/${imageSlug}`;
        }
        ...
        deleteForm.onsubmit = function(e) {
            ...
            if (!reason || reason.trim().length < 10) {
                Swal.fire({
                    title: '<?php echo e(__("global.error")); ?>',
                    text: '<?php echo e(__("dental_management.patient_images.validation.delete_reason_min")); ?>',
                    icon: 'error'
                });
                return;
            }
            ...
            submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> <?php echo e(__("global.processing")); ?>';
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        title: '<?php echo e(__("global.success")); ?>',
                        text: '<?php echo e(__("global.deleted_successfully")); ?>',
                        icon: 'success',
                        timer: 2000,
                        showConfirmButton: false
                    }).then(() => {
                    ...
                    if (data.errors && data.errors.reason) {
                        ...
                        Swal.fire({
                            title: '<?php echo e(__("global.error")); ?>',
                            text: data.message || '<?php echo e(__("global.error_occurred")); ?>',
                            icon: 'error'
                        });
                    }
                }
            ...
            .finally(() => {
                ...
                submitBtn.innerHTML = '<i class="fas fa-trash"></i> <?php echo e(__("global.yes_delete")); ?>';
            });
        };
    }
    ...
    function handleEditImage(imageId, imageTitle, imageDescription, imageSrc) {
        ...
        if (editForm) {
            editForm.action = `<?php echo e(url('dental_management/patient_images')); ?>/${imageId}`;
        }
...
<?php /**PATH C:\laragon\www\blog_main_base\resources\views/dental_management/patients/partials/form_show_images.blade.php ENDPATH**/ ?>