<form id="form-save" action="<?php echo e(route('dental_management.consultations.update', $consultation)); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <?php echo method_field('PUT'); ?>

    <?php
        $patientInfo = trim(($consultation->patient->name ?? '') . ' ' . ($consultation->patient->last_name ?? ''));
        $patientInfo = $patientInfo ?: 'N/A';
        $patientDocument = $consultation->patient->document ?? null;
        if ($patientDocument) {
            $patientInfo .= ' - ' . $patientDocument;
        }
    ?>

    <?php if(($isPatientLocked ?? false) && $consultation->patient_id): ?>
        <input type="hidden" name="patient_id" value="<?php echo e($consultation->patient_id); ?>">
        <div class="form-group">
            <label><?php echo e(__('dental_management.consultations.fields.patient')); ?></label>
            <input type="text" class="form-control" value="<?php echo e($patientInfo); ?>" readonly>
        </div>
    <?php else: ?>
        <div class="form-group">
            ...
            <select name="patient_id" id="patient_id" class="form-control" required>
                ...
                <?php $__currentLoopData = \App\Models\Patient::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patientOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($patientOption->id); ?>" <?php echo e((old('patient_id') ?? $consultation->patient_id) == $patientOption->id ? 'selected' : ''); ?>>
            ...
            <div class="form-group">
                ...
                <select name="treatment_id" id="treatment_id" class="form-control select2" required>
                    ...
                    <?php $__currentLoopData = $treatments ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $treatment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($treatment->id); ?>" <?php echo e((old('treatment_id') ?? $consultation->treatment_id) == $treatment->id ? 'selected' : ''); ?>>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="date" name="consultation_date" id="consultation_date" class="form-control"
                       value="<?php echo e(old('consultation_date', $consultation->consultation_date->format('Y-m-d'))); ?>" required>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="time" name="consultation_time" id="consultation_time" class="form-control"
                       value="<?php echo e(old('consultation_time', $consultation->consultation_time?->format('H:i'))); ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" name="fever" id="fever" class="form-control"
                           value="<?php echo e(old('fever', $consultation->fever)); ?>" step="0.1" min="30" max="45">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="blood_pressure" id="blood_pressure" class="form-control"
                       value="<?php echo e(old('blood_pressure', $consultation->blood_pressure)); ?>" placeholder="120/80">
            ...
            <div class="form-group">
                ...
                <select name="doctor_id" id="doctor_id" class="form-control select2" required>
                    ...
                    <?php $__currentLoopData = $doctors ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($doctor->id); ?>" <?php echo e((old('doctor_id') ?? $consultation->doctor_id) == $doctor->id ? 'selected' : ''); ?>>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control"
                          rows="2" maxlength="1000" required><?php echo e(old('description', $consultation->description)); ?></textarea>
...
<?php /**PATH C:\laragon\www\blog_main_base\resources\views/dental_management/consultations/partials/form_edit.blade.php ENDPATH**/ ?>