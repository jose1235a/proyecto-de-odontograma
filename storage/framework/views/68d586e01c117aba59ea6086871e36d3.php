<?php $__env->startSection('title', __('dental_management.patients.create')); ?>
...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-body">
        <?php echo $__env->make('dental_management.patients.partials.form_create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      </div>
    ...
    $('#document').on('blur', function() {
        ...
        if ($('#document_type').val() === 'dni') {
            ...
            if (dni.length === 8 && /^\d+$/.test(dni)) {
                ...
                $.ajax({
                    url: '<?php echo e(route("dental_management.patients.dni.lookup")); ?>',
                    method: 'POST',
                    data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blog_main_base\resources\views/dental_management/patients/create.blade.php ENDPATH**/ ?>