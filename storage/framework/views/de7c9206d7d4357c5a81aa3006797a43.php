...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('#patient_id').on('change', function() {
        ...
        if (patientId) {
            ...
            fetch(`<?php echo e(url('dental_management/payments/search_patient_appointments')); ?>?patient_id=${patientId}`, {
                headers: {
...
</style><?php /**PATH C:\laragon\www\blog_main_base\resources\views/dental_management/payments/partials/scripts.blade.php ENDPATH**/ ?>