<?php $__env->startSection('title', __('dental_management.appointments.edit_title')); ?>
...
<?php echo $__env->make('dental_management.appointments.partials.form_scripts', [
    'searchPatientUrl' => route('dental_management.appointments.search_patient'),
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blog_main_base\resources\views/dental_management/appointments/edit.blade.php ENDPATH**/ ?>