...
@section('title', __('dental_management.patients.edit_all_title'))
  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-footer text-center">
        ...
        <a href="{{ route('dental_management.patients.edit_all') }}" class="btn btn-default">
    ...
    <div class="card card-info rounded">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a class="btn btn-sm bg-olive mr-2" href="{{ route('dental_management.patients.index') }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('dental_management.patients.partials.edit_all_results')
        </div>
      </div>
    </div>
  </div>
...
@include('dental_management.patients.partials.edit_all_scripts')