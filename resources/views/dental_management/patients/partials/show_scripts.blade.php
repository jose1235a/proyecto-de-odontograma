...
function exportPayments() {
    ...
    const exportUrl = '{{ route("dental_management.payments.export_excel") }}?' + params.toString();
...
const dataTableLanguage = {
    ...
    zeroRecords: '{{ __('global.datatable.zero_records') }}',
    ...
    paginate: {
        ...
        previous: '{{ __('global.datatable.previous') }}',
    },
};
...
<script type="module" src="{{ asset('adminlte/js/patient-show.js') }}"></script>
