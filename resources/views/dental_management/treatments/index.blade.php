...
@section('title', __('dental_management.treatments.title'))
...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-body">
        <form id="treatments-filter-form" method="GET" action="{{ route('dental_management.treatments.index') }}">
      ...
      <div class="card-footer text-center">
        ...
        <a href="{{ route('dental_management.treatments.index') }}" class="btn btn-default">
    ...
    <div class="card card-info rounded">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          @endcan
          @can('treatments.edit_all')
          <a class="btn btn-sm bg-olive mr-2" href="{{ route('dental_management.treatments.edit_all') }}">
            <i class="fas fa-edit"></i> <span class="d-none d-sm-inline">{{ __('global.edit_all') }}</span>
          </a>
          @endcan
          @can('treatments.export')
          <div class="btn-group mr-2">
            <button type="button" class="btn btn-sm btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fas fa-file-export"></i> <span class="d-none d-sm-inline">{{ __('global.export') }}</span>
            </button>
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item text-dark" href="{{ route('dental_management.treatments.export_excel', request()->query()) }}">
                <i class="fas fa-file-excel text-success"></i> {{ __('global.excel') }}
              </a>
              <a class="dropdown-item text-dark" href="{{ route('dental_management.treatments.export_pdf', request()->query()) }}">
                <i class="fas fa-file-pdf text-danger"></i> {{ __('global.pdf') }}
              </a>
              <a class="dropdown-item text-dark" href="{{ route('dental_management.treatments.export_word', request()->query()) }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('dental_management.treatments.partials.index_results')
        </div>
      </div>
...
@push('scripts')
@include('dental_management.treatments.partials.scripts')
@endpush
