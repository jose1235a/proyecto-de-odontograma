...
@section('title', __('dental_management.consultations.create_title'))
  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      <div class="card-header">
        <h3 class="card-title">
          <i class="fas fa-plus"></i> {{ __('dental_management.consultations.create') }}
        </h3>
      ...
      <div class="card-body">
        @include('dental_management.consultations.partials.form_create')
      </div>
      <div class="card-footer text-center">
        <button type="submit" form="form-save" class="btn btn-primary mr-4">
          <i class="fas fa-save"></i> {{ __('global.save') }}
        </button>
        <a href="{{ $return_url ?? route('dental_management.consultations.index') }}" class="btn btn-default">
