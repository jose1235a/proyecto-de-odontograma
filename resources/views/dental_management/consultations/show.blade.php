...
@section('title', __('dental_management.consultations.show_title'))
  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      <div class="card-header">
        <h3 class="card-title">
          <i class="fas fa-database"></i> {{ __('dental_management.consultations.show_title') }}
        </h3>
      ...
      <div class="card-body">
        @include('dental_management.consultations.partials.form_show')
      </div>
