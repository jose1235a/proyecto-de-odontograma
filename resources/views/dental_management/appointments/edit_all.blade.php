...
@section('title', __('dental_management.appointments.edit_all_title'))
...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-body">
        <form id="appointments-edit-filter-form" method="GET" action="{{ route('dental_management.appointments.edit_all') }}">
          @include('dental_management.appointments.partials.index_filters')
        </form>
      </div>
      <div class="card-footer text-center">
        <button type="submit" form="appointments-edit-filter-form" class="btn btn-primary mr-4">
          <i class="fas fa-search"></i> {{ __('global.search') }}
        </button>
        <a href="{{ route('dental_management.appointments.edit_all') }}" class="btn btn-default">
    ...
    <div class="card card-info rounded">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a class="btn btn-sm bg-olive mr-2" href="{{ route('dental_management.appointments.index') }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('dental_management.appointments.partials.edit_all_results')
        </div>
      </div>
    </div>
  </div>
...
@push('scripts')
@include('dental_management.appointments.partials.edit_all_scripts')
@endpush
