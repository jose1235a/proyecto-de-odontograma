...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        buttonText: {
            today: '{{ __("dental_management.calendar.button_today") }}',
            month: '{{ __("dental_management.calendar.button_month") }}',
            week: '{{ __("dental_management.calendar.button_week") }}',
            day: '{{ __("dental_management.calendar.button_day") }}',
            list: '{{ __("dental_management.calendar.button_list") }}'
        },
        dayMaxEventRows: 3,
        events: {
            url: '{{ route('dental_management.calendar.events') }}',
            method: 'GET'
        },
        eventDisplay: 'block',
        ...
        eventClick: function (info) {
            ...
            document.getElementById('eventNotes').textContent = extended.notes || '{{ __('global.none') }}';
