...
@section('title', __('dental_management.doctors.edit_title'))
  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      <div class="card-header">
        <h3 class="card-title">
          <i class="fas fa-edit"></i> {{ __('dental_management.doctors.edit') }}
        </h3>
      ...
      <div class="card-body">
        @include('dental_management.doctors.partials.form_edit')
      </div>
