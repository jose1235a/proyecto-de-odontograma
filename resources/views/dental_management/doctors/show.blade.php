...
@section('title', __('dental_management.doctors.show_title'))
...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-body">
        @include('dental_management.doctors.partials.form_show')
      </div>
      <div class="card-footer text-center">
        <a href="{{ route('dental_management.doctors.index') }}" class="btn btn-secondary" title="{{ __('global.back') }}">
...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        @include('dental_management.doctors.partials.form_show_audit')
      </div>
    </div>
  </div>
</div>
